...
`;const f=h.exports.compile(g);class w{constructor(){this.fragment=new DocumentFragment}add(e){const t=document.createElement("div");t.classList.add("column","col-3","col-xl-4","col-md-6","col-sm-12","p-1"),t.innerHTML=f(e,{allowedProtoProperties:{actions:!0,badges:!0}}),this.fragment.appendChild(t)}apply(){const e=document.getElementById("list");for(;e.lastChild;)e.removeChild(e.lastChild);e.appendChild(this.fragment)}}const d={map:new v,list:new w};class b{constructor(e){this.notes=[],this.query=null,this.view=e}set view(e){const t=Object.keys(d);if(!t.includes(e))throw new TypeError(`Argument must be one of ${t.join(", ")}`);this._view={name:e,handler:d[e]},this.reload()}get view(){return this._view.name}show(e,t,a){this.query=t,this.notes=e;const r=e.length,o=e.reduce((i,s)=>i+s.created.getTime(),0)/r;return e.forEach(i=>{this.isNoteVisible(i,t)&&this._view.handler.add(i,t)}),this._view.handler.apply(a),Promise.resolve({amount:r,average:new Date(o)})}isNoteVisible(e,t){return(t.data.status===n.OPEN?e.status===n.OPEN:!0)&&(t.data.status===n.CLOSED?e.status===n.CLOSED:!0)}get(e){return this.notes.find(t=>t.id===e)}update(e,t){const a=this.notes.findIndex(r=>r.id===e);if(a===-1)throw new Error(`The note with the id ${e} could not be found in the array`);return this.notes[a]=t,this.reload()}reload(){return this.show(this.notes,this.query,!0)}}export{b as default};
//# sourceMappingURL=ui.df2b134d.js.map
